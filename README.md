...
│   └── sample_parquet/                       # Parquet copy of the dataset (generated by the notebook)
│
├── output/
│   ├── csv/                                  # Pipeline + exercise outputs written as CSV
│   └── parquet/                               # Pipeline + exercise outputs written as Parquet
│
└── README.md
```
